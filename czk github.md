...
- **[GitHub Repository](https://github.com/qarmin/czkawka)**: For source code and official info.
- **[Submit an Issue](https://github.com/qarmin/czkawka/issues)**: To report bugs or request features.
...
Enjoy a faster, cleaner Mac experience. Czkawka does the dirty work so you don't have to.
 ...
 now be sure to make this a sectio alias czk='/Applications/czkawka 2>/dev/null &'  when making an alias in the zshrc. the 2>/dev/null &'  is important 